...
class BeamSearch(DecodeStrategy):
    ...
    Note that the attributes list is not exhaustive(详细的). Rather, it highlights
    ...
    def advance(self, log_probs, attn):
        ...
        _B = log_probs.shape[0] // self.beam_size  #beam_size * batch_size // beam_size == batch_size
        ...
        step = len(self) #这个类或者他的父类，应该有一个length的属性。
        ...
        #self._batch_index.size() = [30,5]
        #self._beam_offset.size() = [30]
