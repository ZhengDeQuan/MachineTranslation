...
print("cwd = ",os.getcwd())
sys.path.append("../")
sys.path.append('/home/nemo/zhengquan/OpenNMT-py')
sys.path.append('/home/nemo/zhengquan/anaconda3/condabin')
...
def test_rouge(cand, ref):
    ...
    try:
        ...
        r = pyrouge.Rouge155() #No such file or directory: '/home/nemo/.pyrouge/settings.ini' rouge这个暂时先放弃。
